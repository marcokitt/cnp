...
## Fix v6.1
- aggiunge un monitor delle "decisions" basato sui link realmente creati dal planner batch
- barra di avanzamento `created/planned_total`
- conteggio separato di completed, success ed error
- filtra i link pertinenti all'operation corrente usando start time, paw selezionato e ability dell'adversary operativo
