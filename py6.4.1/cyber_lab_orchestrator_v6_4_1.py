    ...
    def set_operation_state(self, op_id: Any, state: str, autonomous: Optional[bool] = None) -> Any:
        if self.api_mode == "v2":
            ...
            if autonomous is not None:
                payload["autonomous"] = bool(autonomous)
            try:
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Cyber lab orchestrator v6.4.1")
