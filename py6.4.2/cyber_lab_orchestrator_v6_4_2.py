...
def run(config_path: str, interactive_select: bool = False, list_only: bool = False) -> int:
    ...
    write_json(session_dir / "selector_info.json", {"selected_agent": agent, "selected_adversary": selected_adv, "operation_adversary": operation_adv, "temp_adversary_info": temp_adversary_info})
