...
def monitor_loop(cfg: LabConfig, client: Optional[CalderaClient], session_dir: Path, monitor_seconds: int, operation_info: Dict[str, Any], compat: Dict[str, Any], target_markers: Optional[Set[str]] = None) -> Tuple[List[Dict[str, Any]], Dict[str, List[Dict[str, Any]]], Dict[str, Any]]:
...
def run_monitor_only(config_path: str, session_dir: str, monitor_seconds: int) -> int:
    ...
    observed_alerts, grouped, op_status = monitor_loop(cfg, client, session_path, monitor_seconds, operation_info, compat, target_markers=target_markers)
